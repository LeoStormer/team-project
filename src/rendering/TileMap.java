...
public class TileMap {
    ...
    public TileMap(char[][][] layers, TileAtlas tileAtlas, int scale, String code, Camera cam) {
        this.layers = layers;
    ...
    public TileMap(String filename, TileAtlas tileAtlas, int scale, String code, Camera cam) {
        loadMap(filename);
        this.tileAtlas = tileAtlas;
        this.S = scale;
        this.code = code;
    ...
    public void loadMap(String filename) {
        File file = new File("res/txtmaps/" + filename);
                    ...
                    if (c != '.') {
                        ...
                        if (tileIndex != -1) {
                            ...
                            if (tile != null) {
                                ...
                                int x = (int) (col * S - cam.getPosition().getX());
                                int y = (int) (row * S - cam.getPosition().getY());
